...
define('modules/components/pic',['exports', 'aurelia-framework', 'aurelia-router', 'aurelia-auth', '../resources/data/pics'], function (exports, _aureliaFramework, _aureliaRouter, _aureliaAuth, _pics) {
  'use strict';
...
define('text!modules/home.html', ['module'], function(module) { module.exports = "<template><style>body{background-color:coral}</style><h1>${message}</h1><compose show.bind=\"showLogin\" view=\"./components/login.html\"></compose><compose show.bind=\"!showLogin\" view=\"./components/register.html\"></compose></template>"; });
...
define('text!modules/components/pic.html', ['module'], function(module) { module.exports = "<template><title>${title}</title><h1>${message} </h1><compose show.bind=\"showList\" show.bind=\"!showForm\" view=\"./components/piclist.html\"></compose><compose show.bind=\"!showList\" show.bind=\"showForm\" view=\"./components/picform.html\"></compose></template>"; });
define('text!modules/pic.html', ['module'], function(module) { module.exports = "<template><style>body{background-color:coral}</style><compose show.bind=\"showList\" show.bind=\"!showForm\" view=\"./components/piclist.html\"></compose><compose show.bind=\"!showList\" show.bind=\"showForm\" view=\"./components/picform.html\"></compose></template>"; });
